...
function AuthHeader() {
  return (
    <header className="sticky top-0 z-10 flex shrink-0 items-center justify-between gap-3 border-b border-accent/10 bg-linear-to-b from-background via-background to-background/95 px-4 py-3 backdrop-blur-md sm:px-6">
